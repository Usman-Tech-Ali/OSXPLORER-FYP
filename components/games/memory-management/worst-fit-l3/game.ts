...
export class WorstFitGameL3 extends Phaser.Scene {
  ...
  private totalBoxes: number = 20; // Hard difficulty: 20 boxes to spawn
  ...
  private readonly BOX_SPAWN_INTERVAL = 1800; // Hard difficulty: Much faster spawn (1.8s)
