...
export class WorstFitGameL2 extends Phaser.Scene {
  ...
  private totalBoxes: number = 15; // Medium difficulty: 15 boxes to spawn
  ...
  private readonly BOX_SPAWN_INTERVAL = 2200; // Medium difficulty: Faster spawn (2.2s)
