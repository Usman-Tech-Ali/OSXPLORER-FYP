...
export class CriticalSectionGameL2 extends Phaser.Scene {
  ...
  private totalPersons: number = Phaser.Math.Between(5, 6); // L2: Increased from 4
  ...
  private spawnNextPerson() {
    ...
    // L2: More varied ATM usage time between 2-8 seconds with finer granularity
...
export const CriticalSectionGameL2Config = {
  type: Phaser.AUTO,
  backgroundColor: '#181c24',
  scene: CriticalSectionGameL2,
  physics: {
    default: 'arcade',
    arcade: {
      gravity: { x: 0, y: 0 },
