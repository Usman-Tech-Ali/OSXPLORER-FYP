...
export class MutexGameScene extends Phaser.Scene {
  ...
  private async submitScore() {
    try {
      ...
      const accuracy = this.score > 0 ? ((this.score / (this.score + this.crashes)) * 100) : 0;
