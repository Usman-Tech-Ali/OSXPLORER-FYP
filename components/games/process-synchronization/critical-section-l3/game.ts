...
export class CriticalSectionGameL3 extends Phaser.Scene {
  ...
  private totalPersons: number = Phaser.Math.Between(7, 8); // L3: Hard difficulty with more persons
  ...
  private spawnNextPerson() {
    ...
    // L3: Highly varied ATM usage time between 1.5-9 seconds with high randomness
...
export const CriticalSectionGameL3Config = {
  type: Phaser.AUTO,
  backgroundColor: '#181c24',
  scene: CriticalSectionGameL3,
  physics: {
    default: 'arcade',
    arcade: {
      gravity: { x: 0, y: 0 },
